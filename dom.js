...
console.log(ans2);
let ans3=document.querySelector('#abha');
console.log(ans3);
...
//getElemntById
let id=document.getElementById('abha');
console.log(id);
...
heading.innerText +="abhabajpai";//update
...
let parentElement=document.querySelector('.abhi');
